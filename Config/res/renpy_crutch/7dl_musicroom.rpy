# Честно скопипащенный кусок ренпая для замены вызовов renpy.music.get_playing на get_playing_7dl в MusicRoom

init -1500 python:

    @renpy.pure
    class __MusicRoomPlay_7dl(Action, FieldEquality):
        """
        ...
        def get_selected(self):
            return get_playing_7dl(self.mr.channel) == self.filename
    ...
    @renpy.pure
    class __MusicRoomRandomPlay_7dl(Action, FieldEquality):
        """
    ...
    @renpy.pure
    class __MusicRoomTogglePlay_7dl(Action, FieldEquality):
        """
        ...
        def __call__(self):
            if get_playing_7dl(self.mr.channel):
                return self.mr.stop()
        ...
        def get_selected(self):
            return get_playing_7dl(self.mr.channel) is not None


    @renpy.pure
    class __MusicRoomStop_7dl(Action, FieldEquality):
        """
        ...
        def get_selected(self):
            return get_playing_7dl() is None
    ...
    class MusicRoom_7dl(object):
        ...
        def periodic(self, st):
            ...
            current_playing = get_playing_7dl(self.channel)
        ...
        def play(self, filename=None, offset=0, queue=False):
            ...
            if filename is None:
                filename = get_playing_7dl(channel=self.channel)
        ...
        def Play(self, filename=None):
            ...
            return __MusicRoomPlay_7dl(self, filename)
        ...
        def RandomPlay(self):
            ...
            return __MusicRoomRandomPlay_7dl(self)
        ...
        def TogglePlay(self):
            ...
            """
            return __MusicRoomTogglePlay_7dl(self)
        ...
        def Stop(self):
            ...
            return __MusicRoomStop_7dl(self)
