...
init 9999 python:
    ...
    alt_emo_dict = {
                    ...
                    'am':{'1':['grin','normal','surp','sad','smile','smile2','sad_smile','think','pi_grin','pi_normal','pi_sad','pi_smile','pi_surp'],
                          '2':['laugh','normal2','pathetic','pi_laugh','pi_normal2']},
                    'ars':{'1':['laugh','normal','sad','scared','sad_smile','smile','smile2','sorrow','surp'],
                           '2':['neu','smile3','surp2']},
                    'ba':{'1':['em1','evil','normal','smile','rage']},
                    'bb':{'1':['normal','serious','smile']},
                    'cs':{'1':['doubt','fear','grin','laugh','normal','shy','smile','sad','upset','cry','angry','rage','dontlike','tired','serious']},
                    ...
                    'dv':{'1':['concent','cry','scared','shocked','surprise','think'],
                          ...
                          '4':['laugh','normal','sadness','shy2','smile','soft_smile','dontlike','tired'],
                          '5':['angry','rage']},
    ...
    alt_emo_far_dict = {
                    'al':{'1':['angry','dontlike','laugh','normal','sad','shy','smile']},
                    'am':{'1':['pi_sad']},
                    'cs':{'1':['badgirl', 'dontlike', 'doubt','fear','laugh','normal','shy','smile']},
                    'dn':{'1':['dontcare','grin','normal','smile','unsured'],
                          '2':['dontlike','upset'],
                          '3':['sad','scared','shocked','sick','surprise']},
                    'dv':{'1':['concent','cry','scared','shocked','surprise','think'],
